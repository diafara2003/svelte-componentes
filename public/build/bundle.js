...
var app = (function () {
    ...
    function fallback_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$4, 33, 6, 498);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 29, 2, 438);
    			attr_dev(h2, "class", "svelte-pnlh4s");
    			add_location(h2, file$4, 31, 2, 459);
    			attr_dev(p, "class", "svelte-pnlh4s");
    			add_location(p, file$4, 37, 2, 540);
    			attr_dev(div, "class", "jumbotron mt-4 p-3");
    			add_location(div, file$4, 28, 0, 358);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ nombre, mostrar, entrar, salir });
    ...
    function create_subtitulo_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$5, 47, 4, 1155);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(48:4) <span slot=\\\"subtitulo\\\">",
    		ctx
    	});
    ...
    function create_parrafo_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$5, 49, 4, 1201);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$5, 56, 6, 1366);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(hr, file$5, 52, 8, 1278);
    			attr_dev(button, "class", "btn-danger");
    			add_location(button, file$5, 53, 8, 1293);
    			add_location(div, file$5, 51, 6, 1264);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, hr);
    ...
    // (47:2) <Jumbotron nombre="Hello" let:mostrar>
    function create_default_slot(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*mostrar*/ ctx[8]) return create_if_block$1;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(47:2) <Jumbotron nombre=\\\"Hello\\\" let:mostrar>",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$5, 88, 4, 2079);
    			add_location(form, file$5, 63, 2, 1448);
    			attr_dev(div, "class", "container");
    			add_location(div, file$5, 44, 0, 1085);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
